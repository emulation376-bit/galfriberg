                ...
                <div className="rule-sections">
                  <article className="rule-panel rule-panel-main">
                    ...
                    <div className="rule-field-grid">
                      ...
                      <div>
                        <strong>{t('rules.tagsTitle')}</strong>
                        <span>{t('rules.tagsText')}</span>
                      </div>
                      <div>
                        <strong>{t('rules.seriesTitle')}</strong>
                        <span>{t('rules.seriesText')}</span>
                      </div>
                      <div>
                        <strong>{t('rules.lengthTitle')}</strong>
                        <span>{t('rules.lengthText')}</span>
                      </div>
                    </div>
