...
import modeSingleImage from '../assets/mode-single.png';
import modeMultiImage from '../assets/mode-multi.png';
import modeSearchImage from '../assets/mode-search.png';
import modeCharacterImage from '../assets/mode-character.jpg';
    ...
    <div className="page home-page">
      ...
      <main className="page-scroll" id="main-content">
        ...
        <div className="menu-grid">
          ...
          <MenuCard
            to="/character"
            image={modeCharacterImage}
            label={t('home.characterMode')}
            description={t('home.characterModeDescription')}
            color="#ff8fb3"
          />
          <MenuCard
            to="/search"
            image={modeSearchImage}
            label={t('home.search')}
      ...
      <div className="bottom-bar">
        ...
        <HomeSpecialThanks />
        <a
          href="https://space.bilibili.com/3494350759659713"
        ...
        <a
          href="https://github.com/emulation376-bit/galfriberg"
