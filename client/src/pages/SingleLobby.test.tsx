...
describe('SingleLobby', () => {
  ...
  it('defaults to recommended beginner with distinct card copy', () => {
    ...
    const beginner = screen.getByRole('button', { name: /热门版/ });
    const easy = screen.getByRole('button', { name: /进阶版/ });
    ...
    expect(beginner).toHaveTextContent('高知名度作品池 · 熟悉规则');
    expect(easy).toHaveTextContent('知名作品池 · 快速上手');
